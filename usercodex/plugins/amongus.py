...
async def _(event):
    ...
    codevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await codevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await codevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    codevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await codevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
