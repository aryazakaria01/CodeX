...
async def ban_user(chat_id, i, rights):
    try:
        await codex(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
    ...
    async for i in event.client.iter_participants(
        ...
        try:
            ...
            try:
                ...
                pass
    await codevent.edit(f"**Unbanned :**__{succ}/{total} in the chat {chat.title}__")
