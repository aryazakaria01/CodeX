...
from . import codex, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m usercodex`",
        "**State changed from starting to up**",
        "__INFO:usercodex:Logged in as 557667062__",
        "__INFO:usercodex:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
