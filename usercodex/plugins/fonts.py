...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}fmusical codexuserbot",
    },
)
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}vapor codexuserbot",
    },
)
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps codexuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}blackbf codexuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@codex.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}bubbles codexuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
