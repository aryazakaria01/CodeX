...
async def _(event):
    ...
    codevent = await edit_or_reply(event, "`wi8..! I am searching your lyrics....`")
    ...
    if event.pattern_match.group(1):
        ...
        return await codevent.edit("`What I am Supposed to find `")
    song = ""
    ...
    await edit_or_reply(codevent, reply)
...
async def lyrics(lyric):
    ...
    try:
        ...
        songs = None
    if songs is None:
        return await codevent.edit(f"Song **{artist} - {song}** not found!")
