...
from wand.image import Image as codimage

from .utils import _codutils
...
async def cod_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def cod_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = codimage(filename=picture_name)
    main_image.resize(
